...
if ($_SERVER['REQUEST_METHOD'] === 'OPTIONS') {
	...
	header("Access-Control-Allow-Headers: authorization, token, app_id, deviceid, Info, Origin, X-Requested-With, Content-Type, Accept, pragma, priority, cache-control");
